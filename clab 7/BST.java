...
public class BST<Key extends Comparable<Key>> {
    ...
    // return the average depth of BST
    ...
    private int internalPathLengthHelper(Node x, int depth) {
        if (x == null){
            return 0;
        }
        return depth + internalPathLengthHelper(x.left, depth + 1)
                + internalPathLengthHelper(x.right, depth + 1);
    }
